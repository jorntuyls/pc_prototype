...
def parse_arguments():
    ...
    parser.add_argument("-c", "--cutoff", type=int, default=1800, help="Cutoff time for one run")
    ...
    parser.add_argument("-ifs", "--intensification_fold_size", type=int, default=10, help="Intensification fold size")
