...
class BernoulliNBNode(Node):
    ...
    def initialize_algorithm(self, hyperparameters):
        ...
        bernoulli_nb = self.algorithm(alpha=hyperparameters["alpha"],
                                      fit_prior=hyperparameters["fit_prior"])

        return (self.get_full_name(), bernoulli_nb)
...
class BernoulliNB(ClassificationAlgorithm):
