...
class RandomForestNode(Node):
    ...
    def initialize_algorithm(self, hyperparameters):
        ...
        random_forest = self.algorithm(n_estimators=hyperparameters["n_estimators"],
                             criterion=hyperparameters["criterion"], # Actual hyperparameter
                             ...
                             max_leaf_nodes=hyperparameters["max_leaf_nodes"]) # Actual hyperparameter

        return (self.get_full_name(), random_forest)
