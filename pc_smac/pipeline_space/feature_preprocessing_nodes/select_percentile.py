...
class SelectPercentileNode(Node):

    def __init__(self):
        self.name = "select_percentile"
        self.type = "feature_preprocessor"
        self.hyperparameters = {"percentile": 50, "score_func": "chi2"}
        self.algorithm = SelectPercentile

    def initialize_algorithm(self, hyperparameters):
        hyperparameters = self.initialize_hyperparameters(hyperparameters)
        select_percentile = self.algorithm(percentile=hyperparameters["percentile"],
...
class SelectPercentile(SelectPercentileBase,
